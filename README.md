...
|:------:|:------:|:------:|:------:|:------:|       
 |<p align="center"> <sub> <i> Novel ACSTFT Transform <br> Top: normal, bottom: default </i> </sub>  </p>  |  <p align="center"> <sub><i> ROC-AUC= 0.99 <br> Valve Type id_04  </i>  </sub>  </p>       |   <p align="center"> <sub><i> Reconstruction error (MSE) <br> Valve type id_04  </i></sub>  </p> |  <p align="center"> <sub><i> MVDR beamforming <br> Beampattern 1000Hz  </i> </sub>  </p> |    <p align="center"> <sub><i> Denoised Valve Sound Signals <br> with VAD Decision  </i></sub>  </p> |    
